...
fname = np.loadtxt("data_dx100.dat", unpack = True, usecols = (2,3))
fname2 = np.loadtxt("data_dx200.dat", unpack = True, usecols = (2,3))
fname3 = np.loadtxt("data_dx400.dat", unpack = True, usecols = (2,3))
fname4 = np.loadtxt("data_dx800.dat", unpack = True, usecols = (2,3))
...
plt.legend(['Numerical100','Numerical200','Numerical400','Numerical800'], loc = 'upper right')
...
#plt.ylim((-0.1,1.1))
#plt.show()
plt.savefig('fig/100_dxdifferr.png')
plt.close()