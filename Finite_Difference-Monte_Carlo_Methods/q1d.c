...
int main()
{
	...
	double bc_limit=500.0, bin=2.5, tot=0.0, n_x_temp;
	double dt=1.;
	int N_s = 2*bc_limit/bin;
	int N_t=5000, N_p=10000, N_pa=N_p, ratio=200;
	...
	// output data
	strcpy (name_file, "/Users/natii/nati/UIUC/2014Fall/CPA/ps9/q1d/data/n2.dat");
	...
	strcpy (name_file2, "/Users/natii/nati/UIUC/2014Fall/CPA/ps9/q1d/data/t2.dat");
	...
	strcpy (name_file3, "/Users/natii/nati/UIUC/2014Fall/CPA/ps9/q1d/data/x2.dat");
